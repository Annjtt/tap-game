import{C as r,i as c,N as m}from"./index-CL9j04Cq.js";class d{static showCard(o,e,n){console.log("CardsDisplay.showCard вызван",{card:o,item:e,game:n}),r.show(o);const t=document.createElement("div");t.className="card-overlay";const i=c(`images/cards/${o.toLowerCase()}.png`),l=c(e.image);t.innerHTML=`
