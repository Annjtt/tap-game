import{i,I as l}from"./index-CSUXLtTJ.js";class v{static showCard(d,e,a,c){const t=document.createElement("div");t.className="card-overlay";const n=i(`images/cards/${d.toLowerCase()}.png`),o=i(e.image);t.innerHTML=`
